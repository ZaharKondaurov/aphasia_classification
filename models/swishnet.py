...
class MaskedConv1d(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, dilation=1, mask=None, input_size=42):
        ...
        # padding = stride * (kernel_size - 1) // 2
        # if kernel_size % 2 == 0:
        #     padding -= 1
...
class SwishNet(nn.Module):
    ...
    def __init__(self, in_channels=3, out_channels=2, input_size=42, dropout_rate=0.1):
        ...
        self.gatedconv7 = GatedConv1d(in_channels=16, out_channels=16, kernel_size=kernel_size_3, mask=mask_3, stride=2, input_size=input_size)

        self.batchnorm7 = nn.BatchNorm1d(16)
        self.gateconv8 = GatedConv1d(in_channels=16, out_channels=32, kernel_size=kernel_size_3, mask=mask_3, stride=2, input_size=input_size)
